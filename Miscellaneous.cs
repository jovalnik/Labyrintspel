...
namespace TheGame001
{
    public static class Miscellaneous
    {
        ...
        public static Dictionary<string, Item> ExistingThings = new Dictionary<string, Item>()
        {
            ...
            { "Kyrass",new Armor {Name ="Kyrass", SuggestedPrice=1, Description="Ett harnesk av 3mm stålplåt S255JR. -20 träffchans, +40 skadereduktion",  ToHitBonus=-20, DamageReductionBonus=0}},
