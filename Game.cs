...
namespace TheGame001
{
    public class Game
    {
        ...
        {                                               // fast kanske ändå..?,
            Monsters.Add(new Monster("minitaur", 'A'));
            Monsters.Add(new Monster("minitaur", 'A'));
            Monsters.Add(new Monster("minitaur", 'A'));
            Monsters.Add(new Monster("minitaur", 'A'));
            Monsters.Add(new Monster("minitaur", 'A'));
        ...
        void EraseMonster(Monster abomination)
        {
            ...
            Console.Write(' ');
            ////Console.ForegroundColor = ConsoleColor.Yellow;
            //int y=varmint.Position[0];
            //int x=varmint.Position[1];
            ////int LabLY = Labyrint.GetLength(0);
            ////int LabLX = Labyrint.GetLength(1);
            ////char[,] overlay = new char[LabLY,LabLX];
            ...
            //    for (int j = -1; j <= 1; j++)
            //    {
            //        SetColorForPrint(y + i, x + j);
            //        Console.SetCursorPosition(y + i, x + j);
            //        Console.Write(Labyrint[y + 1, x + j]);
            //        Console.ForegroundColor = ConsoleColor.White;
            //        Console.BackgroundColor = ConsoleColor.Black;
            //    }
            //}
            ...
            ////for (int k = 0; k < LabLY; k++)             // lägg in nollor överallt
            ////{
            ////    for (int l = 0; l < LabLX; l++)
            ////    {
            ////        Overlay[k, l] = '0';
            ////    }
            ////}
            ...
            ////for (int m = 0; m < LabLY; m++)             
            ////{
            ////    for (int n = 0; n < LabLX; n++)
            ////    {
            ////        //Overlay[m, n] = '0';
            ...
            ////SetColorForPrint ()
            ////Console.Write(Labyrint[(y - 1),x]);          
            ////Console.SetCursorPosition((y + 1), x);
            ////Console.Write(Labyrint[(y + 1),x]);
            ////Console.SetCursorPosition((y ), x+1);
            ////Console.Write(Labyrint[(y),x+1]);
            ////Console.SetCursorPosition((y), x-1);
            ////Console.Write(Labyrint[(y),x-1]);
            ////Console.SetCursorPosition((y), x);
            ////Console.Write(Labyrint[(y),x]);
            ////Console.SetCursorPosition(y, x);
            ////Console.Write(varmint.Symbol);

            ////Console.SetCursorPosition(0, 0);
            ////Console.Write("monster " + varmint.Name + " pos1 " + varmint.Position[1] + " pos 0" + varmint.Position[0]);
            ////Console.ReadKey();
