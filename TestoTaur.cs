        ...
        public override void Move(Game myGame, Player player)
        {
            ...
            (int,bool) Generate((int, int) current, Player player) ///GENERATE BÖRJAR HÄR///////////////////////////////////////
            {
 ...
 
                {
                    ...
                    ////Console.Write ("Current: (" + current.Item1 + "," + current.Item2 + ")");
                    //Console.SetCursorPosition(current.Item2, current.Item1);
                    //Console.BackgroundColor = ConsoleColor.Red;
                    //Console.ForegroundColor = ConsoleColor.Yellow;
                    //Console.CursorVisible = false;
                    //Console.Write(myGame.Labyrint[current.Item1, current.Item2]);
                    ////Thread.Sleep(20);
                    //Console.SetCursorPosition(5, 75);
                    //Console.Write ("Current: (" + current.Item1 + "," + current.Item2 + ")");
                    //Console.SetCursorPosition(player.Position[1], player.Position[0]);
                    //Console.Write('P');
                    ...
                    if (current.Item1 == player.Position[0] && current.Item2 == player.Position[1])
                    {
                        ...
                        //foreach (var item in Path)
                        //{
                        //    Console.WriteLine("(" + item.Item1 + "," + item.Item2 + ") Path"+Path.Count);
                        //}
                        //Console.ReadLine();
